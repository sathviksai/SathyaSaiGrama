...
import { Modal, View, Text, Button, StyleSheet, TouchableOpacity, TouchableWithoutFeedback, Animated, Dimensions, TextInput, Image } from 'react-native';
...
const Filter = ({ setFilteredData, ToFilterData }) => {
  ...
  const displayFilterCategory = ["Guest Category", "Priority", "Home or Office", "Gender", "Single or Group"];
  const filterCategory = ["Guest_Category", "Priority", "Home_or_Office", "Gender", "Single_or_Group_Visit"];
                      ...
                      }
                      {
                        selectedCategory === "Phone" && <>
                          ...
                          <View style={styles.filterrightsecond}>
                            ...
                            <TextInput placeholder={selectedCategory} style={styles.txtinput} onChangeText={(txt) => onPhoneChange(txt)} value={phone} />
                          </View>
                        </>
                      }
                      {
                        ...
                        idx !== null && (
                          filterValues[idx].map((value, i) => {
                            return (
                              ...
                              >
                                <Text style={isValueSelected(idx, value) && styles.selectedTextValue}>{value}</Text>
                              </TouchableOpacity>
                            );
                          })
                        )
