...
const Login = ({ navigation }) => {
    ...
    const { userType, setUserType, accessToken, setUserEmail, setL1ID, loggedUser, setLoggedUser, deviceToken } = useContext(UserContext)
            ...
            try {
                ...
                if (user.emailVerified) {
                    ...
                    const updateData = {
                      ...
                      const updateResponse = await updateDeviceToken(updateData, res.data[0].ID)
                    ...
                    <KeyboardAvoidingView>
                        ...
                        <View style={[styles.head]}>
                            ...
                            {errors.password?.type === 'pattern' && (
                                <Text style={styles.textError}>
                                    Password must contain at least a uppercase,lowercase, number and
                                    a special character
                                </Text>
                            )}
